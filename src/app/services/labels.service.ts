...
export class LabelsService {
    ...
    private readonly DefaultBrowserLcid = 1033;
    private readonly DefaultUserLanguage = 'en-US';
    private readonly selectedLanguageLcidCookieKey: string = 'selected-language-lcid';
    ...
    private getSelectedlcid(): number {
        if (this.isSelectedLanguageLcidSaved()) {
